...
CREATE POLICY "Users can create their own reviews" ON public.app_reviews
  FOR INSERT WITH CHECK (auth.uid() = user_id);

-- Only review authors can update their own reviews
...
-- Update app upload page to support new fields
